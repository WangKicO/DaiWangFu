...
public class Camera_crol6 : MonoBehaviour {
...
//		{
		...
		cam.transform.LookAt (obj.transform.position);
			cam.transform.position =new Vector3 ( obj.transform.position.x+25, obj.transform.position.y+6, obj.transform.position.z);
