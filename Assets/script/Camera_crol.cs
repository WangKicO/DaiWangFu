...
public class Camera_crol : MonoBehaviour {
...
//		{
		...
		cam.transform.LookAt (obj.transform.position);
			cam.transform.position =new Vector3 ( obj.transform.position.x+15, obj.transform.position.y+5, obj.transform.position.z+5);
