...
public class Camera_crol2 : MonoBehaviour {
...
//		{
		...
		//cam.transform.LookAt (obj.transform.position);
			cam.transform.position =new Vector3 ( obj.transform.position.x+19, obj.transform.position.y+5, obj.transform.position.z+0.5f);
