...
public class Camera_crol7 : MonoBehaviour {
...
//		{
		...
		cam.transform.LookAt (obj.transform.position);
			cam.transform.position =new Vector3 ( obj.transform.position.x+25, obj.transform.position.y+9, obj.transform.position.z-6);
