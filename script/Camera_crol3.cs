...
public class Camera_crol3 : MonoBehaviour {
...
//		{
		...
		cam.transform.LookAt (obj.transform.position);
			cam.transform.position =new Vector3 ( obj.transform.position.x+38, obj.transform.position.y-5, obj.transform.position.z);
