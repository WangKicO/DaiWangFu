...
public class Camera_crol4 : MonoBehaviour {
...
//		{
		...
		cam.transform.LookAt (obj.transform.position);
			cam.transform.position =new Vector3 ( obj.transform.position.x+18, obj.transform.position.y-1, obj.transform.position.z);
